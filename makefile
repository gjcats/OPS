...
MODULES := binas.f90 m_aps.f90 m_commonconst.f90 m_commonfile.f90 m_depac.f90 m_error.f90 m_fileutils.f90 m_geoutils.f90 \
           m_getkey.f90 m_ops_building.f90 m_ops_emis.f90 m_ops_plumerise.f90 m_ops_utils.f90 m_string.f90 m_utils.f90 

SOURCES := ops_bgcon.f90 ops_bgcon_tra.f90 ops_bron_rek.f90 ops_brondepl.f90 ops_calc_stats.f90 ops_conc_ini.f90 \
